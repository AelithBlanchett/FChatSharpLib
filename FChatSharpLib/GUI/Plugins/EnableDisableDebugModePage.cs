...
namespace FChatSharpLib.GUI.Host
{
    class EnableDisableDebugModePage : Page
    {
        ...
        public override void Display()
        {
            ...
            program.FChatClient.Events.Options.Value.Debug = (input == 1);

            Output.WriteLine("Debug mode is now set to: " + program.FChatClient.Events.Options.Value.Debug.ToString());
